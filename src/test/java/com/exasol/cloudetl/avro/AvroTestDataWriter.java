...
public class AvroTestDataWriter {
    ...
    public final DataFileWriter<GenericRecord> getAvroWriter(final Path path, final Schema schema) throws IOException {
    ...
    public final <T> void writeDataValues(final List<T> values, final Path path, final Schema schema) throws IOException {
