...
* #391: Fixed vulnerability CVE-2026-41417 in dependency `io.netty:netty-codec-http:jar:4.2.12.Final:compile`
...
* Updated `org.apache.spark:spark-sql_2.13:3.5.7` to `4.2.0-preview5`
...
* Updated `org.jetbrains.kotlin:kotlin-stdlib:1.9.25` to `2.3.21`
...
* Updated `software.amazon.awssdk:s3-transfer-manager:2.34.0` to `2.44.4`
* Updated `software.amazon.awssdk:s3:2.34.0` to `2.44.4`
