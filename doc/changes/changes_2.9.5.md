...
Code name: Fixed vulnerability CVE-2026-34480 in org.apache.logging.log4j:log4j-core:jar:2.25.3:compile
...
#### References
* https://ossindex.sonatype.org/vulnerability/CVE-2026-34480?component-type=maven&component-name=org.apache.logging.log4j%2Flog4j-core&utm_source=ossindex-client&utm_medium=integration&utm_content=1.8.1
...
* https://osv-vulnerabilities.storage.googleapis.com/Maven/GHSA-3pxv-7cmr-fjr4.json
* https://www.sonatype.com/products/sonatype-guide/oss-index-users

## Security

* #379: Fixed vulnerability CVE-2026-34480 in dependency `org.apache.logging.log4j:log4j-core:jar:2.25.3:compile`
...
* Updated `software.amazon.awssdk:s3-transfer-manager:2.34.0` to `2.42.33`
* Updated `software.amazon.awssdk:s3:2.34.0` to `2.42.33`
