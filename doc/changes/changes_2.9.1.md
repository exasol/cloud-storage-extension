...
* #360: Fixed vulnerability CVE-2025-58057 in dependency `io.netty:netty-codec:jar:4.1.124.Final:compile`
...
* Updated `com.nimbusds:nimbus-jose-jwt:9.47` to `10.4.2`
...
* Updated `software.amazon.awssdk:s3-transfer-manager:2.32.31` to `2.33.3`
* Updated `software.amazon.awssdk:s3:2.32.31` to `2.33.3`
