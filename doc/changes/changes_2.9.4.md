...
Code name: Fixed vulnerability CVE-2026-24308 in org.apache.zookeeper:zookeeper:jar:3.9.4:compile

## Summary

This release fixes the following vulnerability:

### CVE-2026-24308 (CWE-532) in dependency `org.apache.zookeeper:zookeeper:jar:3.9.4:compile`
...
* #371: Fixed vulnerability CVE-2026-24308 in dependency `org.apache.zookeeper:zookeeper:jar:3.9.4:compile`
...
* Updated `com.github.mwiede:jsch:0.2.21` to `2.27.8`
...
* Updated `software.amazon.awssdk:s3-transfer-manager:2.34.0` to `2.42.10`
* Updated `software.amazon.awssdk:s3:2.34.0` to `2.42.10`
...
* Updated `org.mockito:mockito-core:5.12.0` to `5.22.0`
